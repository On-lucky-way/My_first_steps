...
Orbital= [orbital_radius, orbital_speed]
...
def planet_year():
    ...
    print("The year is {} days on {}".format(int(planet_year1), planet1))
    print("The year is {} days on {}".format(int(planet_year2),M planet2))

    def bigger_year():
        if planet_year1 > planet_year2:
            print("The", planet1, "year is bigger")
        else:
            print("The", planet2, "year is bigger")
...
try:
    ...
    print("Не верное название планеты")
